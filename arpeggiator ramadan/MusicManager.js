...
export var MusicManager = /*#__PURE__*/ function() {
    ...
    function MusicManager() {
        ...
        this.synthPresets = [
            ...
            // Preset 4: Arabic (warm, spacious – default for Ramadan)
            {
                harmonicity: 2.5,
                modulationIndex: 6,
                oscillator: {
    ...
    _create_class(MusicManager, [
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                // Ramadan Edition: slower, Arabic feel (88 BPM)
                                Tone.Transport.bpm.value = 88;
                                // Apply current preset effects (reverb + delay for Arabic preset)
                                var presetEffects = _this.synthPresets[_this.currentSynthIndex].effects;
                                if (presetEffects) {
                                    if (presetEffects.reverbWet != null) _this.reverb.wet.value = presetEffects.reverbWet;
                                    if (presetEffects.delayWet != null) _this.stereoDelay.wet.value = presetEffects.delayWet;
                                }
        ...
        },
        {
            ...
            value: function startArpeggio(handId, rootNote) {
                ...
                // Arabic / Phrygian dominant arpeggio: Root, b2, 3, 4, 5, b6, b7, Octave (semitone steps)
