...
export var Game = /*#__PURE__*/ function() {
    ...
    function Game(renderDiv) {
        ...
        this.lanternLevel = 0.2; // Smoothed level for Ramadan lantern glow (0–1)
    ...
    _create_class(Game, [
        ...
        },
        {
            ...
            value: function _setupDOM() {
                ...
                // Camera in full color (no grayscale)
            ...
            value: function _updateHands() {
                ...
                if (videoTime > this.lastVideoTime) {
                    ...
                    try {
                        ...
                        // Arabic / Phrygian dominant (Hijaz) scale – two octaves
                        var scale = [
                            'C3',
                            'Db3',
                            'E3',
        ...
        },
        {
            ...
            value: function _animate() {
                ...
                if (this.gameState === 'tracking') {
                    ...
                    this._updateLanternGlow();
                    this._updateRamadanSymbol();
                }
                this.renderer.render(this.scene, this.camera);
            }
        },
        {
            key: "_updateLanternGlow",
            value: function _updateLanternGlow() {
                ...
                try {
                    ...
                    var rawLevel = sum / data.length;
                    this.lanternLevel = this.lanternLevel * 0.88 + rawLevel * 0.12;
                    var intensity = 0.15 + Math.min(1, this.lanternLevel * 2.5) * 0.5;
                    document.documentElement.style.setProperty('--lantern-intensity', String(intensity));
                } catch (e) {}
            }
        },
        {
            key: "_updateRamadanSymbol",
            value: function _updateRamadanSymbol() {
                var el = document.getElementById('ramadan-symbol');
                if (!el) return;
                var arpActive = this.musicManager.activePatterns.size > 0;
                var drumsActive = drumManager.getActiveDrums().size > 0;
                var isPlaying = arpActive || drumsActive;
                el.classList.toggle('visible', isPlaying);
            }
        },
        {
